  ...
  >
    ...
    <div class="  flex w-[full] p-[30px] mb-[20px] md:w-[100%] md:flex items-center md:p-[10px] ">
      <div class="flex flex-col border-2 rounded-sm shadow-orange-glow bg-white py-[10px] px-[20px] gap-[15px]">
        ...
        <div
          class="font-[Montserrat] text-[16px] leading-[25px] text-[#4d4c44]"
        >
        ...
        <div class="flex flex-col gap-[5px] font-[Montserrat]">
          <div
            class="flex  font-[Montserrat] flex-row font-medium items-center gap-[20px] border-2 border-black-500 p-[10px] text-[18px] leading-[30px]"
          >
            <Icon
          ...
          <div
            class="flex  font-[Montserrat] flex-row items-center gap-[20px] border-2 border-black-500 p-[10px] text-[18px] leading-[30px] font-medium"
          >
            <Icon

<template>
  ...
  >
    ...
    <div
      class="flex text-white w-[90%] p-[20px] box-border bg-black text-center md:w-[50%] items-center justify-center flex-col gap-[20px] shadow-xl border border-gray"
    >
      <Icon
      ...
      />
      <div
        class=" text-[25px] leading-[37px] text-orange-500"
      >
